<template>
  <div class="group overflow-hidden border-white transition-all ease-in xl:rounded-3xl xl:border-[10px] xl:hover:border-[#CCE3DE] xl:hover:bg-[#CCE3DE]">
    <div class="relative flex items-center justify-center rounded-[12px] bg-[#F1F4FA] p-9 sm:rounded-3xl ">
      ...
      <span class="absolute left-3 top-5 rounded-[3px] bg-primary-foreground px-[6px] py-[3px] text-[7px] font-semibold leading-none text-[#FFDCCD] sm:left-5 md:rounded-md md:px-2.5 md:py-[5px] md:text-xs">-20%</span>
      <span class="absolute left-3 top-[38px] rounded-[3px] bg-primary px-[6px] py-[3px] text-[7px] font-semibold leading-none text-primary-foreground sm:left-5 md:top-[50px] md:rounded-md md:px-2.5 md:py-[5px] md:text-xs">+30 Б</span>
