<template>
  <div class="group overflow-hidden border-white transition-all ease-in xl:rounded-3xl xl:border-[10px] xl:hover:border-[#CCE3DE] xl:hover:bg-[#CCE3DE]">
    <div class="relative flex items-center justify-center rounded-[12px] bg-[#F1F4FA] p-9 sm:rounded-3xl ">
      ...
      <span class="py2.5 absolute left-2 top-5 rounded-md bg-primary-foreground px-1 text-xs text-[#FFDCCD] sm:left-5">-20%</span>
      <span class="py2.5 absolute left-2 top-10 rounded-md bg-primary px-1 text-xs text-primary-foreground sm:left-5">+30 Б</span>
